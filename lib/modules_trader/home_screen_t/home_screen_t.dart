...
class HomeScreen_T extends StatelessWidget {
  final List<BarChartModel> data = [
    BarChartModel(
      week: 'week1', financial: 10,
      color: charts.ColorUtil.fromDartColor(defualtColor),
    ),
    BarChartModel(
      week: 'week2', financial: 20,
      color: charts.ColorUtil.fromDartColor(defualtColor),
    ),
    BarChartModel(
      week: 'week3', financial: 60,
      color: charts.ColorUtil.fromDartColor(defualtColor),
    ),
    BarChartModel(
      week: 'week4', financial: 40,
      color: charts.ColorUtil.fromDartColor(defualtColor),
    ),
    BarChartModel(
      week: 'week5', financial: 30,
      color: charts.ColorUtil.fromDartColor(defualtColor),
    ),
    BarChartModel(
      week: 'week6', financial: 60,
      color: charts.ColorUtil.fromDartColor(defualtColor),
    ),
  ];
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children:  [
                                ImageIcon(
                                  AssetImage("imagies/exchange-rate.png"),
                                  size: 20.0,
                                  color: Colors.white,
                                ),
                                Text(
